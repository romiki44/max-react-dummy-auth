...
function App() {
  ...
  //Context s isLoggedIn a onLogout sa dostane ku vsetkym komponentom
  //a tym padom sa nemusi kaskadovito pouzit props z jedneho komponentu do druheho!
  //v komponente potom treba pouzit useContext(), alebo AuthContext.Consumer....ale lepsie useContext()
  return (
